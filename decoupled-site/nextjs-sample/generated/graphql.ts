 ...
 * __useStartQuery__
 *
 * To run a query within a React component, call `useStartQuery` and pass it any options that fit your needs.
 * When your component renders, `useStartQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useStartQuery({
 *   variables: {
 *      relativePath: // value for 'relativePath'
 *      locales: // value for 'locales'
 *      language: // value for 'language'
 *      stageName: // value for 'stageName'
 *      artistGenre: // value for 'artistGenre'
 *      contentId: // value for 'contentId'
 *      workId: // value for 'workId'
 *      statusEqual: // value for 'statusEqual'
 *      isCommonDraft: // value for 'isCommonDraft'
 *   },
 * });
 */
export function useStartQuery(baseOptions?: Apollo.QueryHookOptions<StartQuery, StartQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<StartQuery, StartQueryVariables>(StartDocument, options);
      }
export function useStartLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<StartQuery, StartQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<StartQuery, StartQueryVariables>(StartDocument, options);
        }
export type StartQueryHookResult = ReturnType<typeof useStartQuery>;
export type StartLazyQueryHookResult = ReturnType<typeof useStartLazyQuery>;
export type StartQueryResult = Apollo.QueryResult<StartQuery, StartQueryVariables>;